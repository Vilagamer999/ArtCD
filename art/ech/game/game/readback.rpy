...
screen text_history:
    ...
    window:
        ...
        side "c r":
            ...
            bar adjustment adj style 'vscrollbar' thumb "ui/slider_thumb_v.png" top_bar "ui/slider_v.png" bottom_bar None bar_resizing True ymaximum 435
        imagebutton auto "ui/bt_back_%s.png" action [Play ("ex_sfx", "sfx/click.wav"), Return()]  xoffset 676 yoffset 435